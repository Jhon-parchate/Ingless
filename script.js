const questions = {
    ...
    "Comparativos de Igualdad y Desigualdad" : {
        easy: [
            { question: "Complete the sentence: 'She is as ___ as her brother.'", options: ["tall", "short", "smart", "young"], answer: 0 },
            { question: "Choose the correct adjective: 'This book is as ___ as that one.'", options: ["interesting", "boring", "heavy", "small"], answer: 0 },
            { question: "What is the correct adjective? 'He runs as ___ as his friend.'", options: ["slow", "fast", "careful", "strong"], answer: 1 },
            { question: "Complete the sentence: 'This car is not as ___ as that one.'", options: ["expensive", "cheap", "new", "comfortable"], answer: 0 },
            { question: "Choose the correct adjective: 'She is as ___ as him.'", options: ["smart", "lazy", "kind", "tall"], answer: 0 },
            { question: "What is the correct answer? 'He speaks as ___ as a teacher.'", options: ["clearly", "loud", "quick", "soft"], answer: 0 },
            { question: "Select the correct adjective: 'This game is not as ___ as the last one.'", options: ["exciting", "boring", "hard", "long"], answer: 0 },
            { question: "Choose the correct option: 'He is as ___ as his brother.'", options: ["good", "bad", "funny", "serious"], answer: 0 },
            { question: "Which is correct? 'This task is as ___ as the other one.'", options: ["difficult", "easy", "long", "important"], answer: 0 },
            { question: "Choose the correct adjective: 'They are as ___ as their parents.'", options: ["hardworking", "lazy", "friendly", "serious"], answer: 0 }
        ],
        medium: [
            { question: "Complete the sentence: 'Her house is not as ___ as her friend's.'", options: ["big", "small", "new", "old"], answer: 0 },
            { question: "What is the correct option? 'This film is as ___ as that one.'", options: ["interesting", "boring", "funny", "scary"], answer: 0 },
            { question: "Choose the correct answer: 'This road is not as ___ as it looks.'", options: ["dangerous", "safe", "smooth", "busy"], answer: 0 },
            { question: "Select the correct adjective: 'He is not as ___ as his father.'", options: ["tall", "short", "old", "young"], answer: 0 },
            { question: "What is the correct answer? 'The cat is as ___ as the dog.'", options: ["agile", "lazy", "slow", "small"], answer: 0 },
            { question: "Choose the correct adjective: 'This meal is as ___ as the one we had yesterday.'", options: ["tasty", "spicy", "hot", "salty"], answer: 0 },
            { question: "Which is correct? 'Her singing is not as ___ as his.'", options: ["good", "bad", "loud", "soft"], answer: 0 },
            { question: "Complete the sentence: 'This movie is not as ___ as that comedy show.'", options: ["funny", "serious", "boring", "exciting"], answer: 0 },
            { question: "Choose the correct adjective: 'My score is as ___ as his.'", options: ["high", "low", "close", "far"], answer: 0 },
            { question: "What is the correct adjective? 'The test is as ___ as expected.'", options: ["challenging", "easy", "boring", "fast"], answer: 0 }
        ],
        hard: [
            { question: "Choose the correct adjective: 'She is not as ___ as her colleague.'", options: ["hardworking", "lazy", "old", "strong"], answer: 0 },
            { question: "Select the correct adjective: 'The new model is as ___ as the old one.'", options: ["efficient", "complicated", "fast", "reliable"], answer: 0 },
            { question: "Complete the sentence: 'This software is as ___ as possible.'", options: ["user-friendly", "complex", "popular", "useful"], answer: 0 },
            { question: "Which sentence is correct? 'Their house is not as ___ as ours.'", options: ["modern", "old", "big", "safe"], answer: 0 },
            { question: "Choose the correct adjective: 'He is not as ___ as his friend.'", options: ["talkative", "quiet", "happy", "calm"], answer: 0 },
            { question: "What is the correct answer? 'This project is as ___ as the previous one.'", options: ["important", "boring", "urgent", "long"], answer: 0 },
            { question: "Choose the correct adjective: 'Their team is not as ___ as last year.'", options: ["strong", "weak", "competitive", "motivated"], answer: 0 },
            { question: "Complete the sentence: 'The view here is as ___ as we imagined.'", options: ["beautiful", "plain", "boring", "amazing"], answer: 0 },
            { question: "What is the correct answer? 'This task is not as ___ as it seems.'", options: ["easy", "hard", "long", "boring"], answer: 0 },
            { question: "Choose the correct adjective: 'The course is as ___ as any professional training.'", options: ["demanding", "boring", "simple", "expensive"], answer: 0 }
        ]
    },
